        ...
        <div className="container mx-auto md:px-10 lg:px-0">
          ...
          <div className="hidden mobile-menu text-center">
            <ul>
              ...
              <a href="/" className="block text-sm px-2 py-4 text-white font-semibold hover:bg-gray-900 hover:text-green-500 transition duration-300">
                Spotify Profile
              </a>
              {isLoggedIn ? 
                <NavLink to="/logout" className="block text-sm px-2 py-4 text-white font-semibold hover:bg-gray-900 hover:text-red-500 transition duration-300">
                  Logout
                </NavLink>
                :
