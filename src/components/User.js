                ...
                <div className="relative" ref={ref}>
                    ...
                    {showUser ? (
                        <div className="absolute right-0 w-40 mt-2 py-2 bg-white border rounded shadow-xl">
                            <a target="_blank" rel="noreferrer" href={spotifyURL} className="block px-4 py-2 text-gray-900 hover:text-green-500">
                                Spotify Profile
                            </a>
                            ...
                            <a href="/" className="block px-4 py-2 text-gray-900 hover:text-red-500">
                                Logout
                            </a>
                            ...
                            <p href="/" className="block px-4 py-2 text-gray-900 hover:text-red-500" onClick={() => {setDeleteModal(!deleteModal); setShowUser(false)}}>
                                Delete Data
                            </p>
                        </div>
                    ) : null}
