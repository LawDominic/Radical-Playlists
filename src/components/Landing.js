    ...
    return (
        <div className="bg-gray-900 relative">
            ...
            <div className="absolute inset-0 flex justify-center items-center flex-col">
                <p className="text-8xl text-white font-bold">Welcome!</p>
                <p className="text-xl text-white mt-4">Upload and share playlists with Spotify users around the world.</p>
                <a
                    href={loginUrl}
